<div class="container-fluid">
    ...
    <div class="card col-md-5 card-prof h-100 align-self-center">
        <div class="card-header">
            <h3 class="text-center">Attribuez un stage à un élève</h3>
        </div>
        ...
        <div class="card-body pt-0">
            <form method="POST" action="{{ route('stage') }}" >
                ...
                <div class="form-row row mb-2">
                    ...
                    <textarea class="form-control col-md-6" style="padding-left: 12px" id="opinion" rows="2" name="opinion"></textarea>
                </div>
